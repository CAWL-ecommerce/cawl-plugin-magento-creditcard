...
class PaymentFromApplicableCustomerGroupsTest extends TestCase
{
     ...
     * @magentoConfigFixture current_store payment/worldline_cc/allow_specific_customer_group 1
     * @magentoConfigFixture current_store payment/worldline_cc/allow_specific_currency 0
     * @magentoConfigFixture current_store payment/worldline_cc/customer_group 1
