...
class SortTest extends TestCase
{
     ...
     * @magentoConfigFixture current_store payment/worldline_cc/sort_order 0
    ...
    public function testFirstInOrder(): void
    {
        ...
        foreach ($paymentMethods as $paymentMethod) {
            ...
            if ($paymentMethod->getConfigData('sort_order') > $ccPaymentMethod->getConfigData('sort_order')) {
                $valid = false;
            }
        }
