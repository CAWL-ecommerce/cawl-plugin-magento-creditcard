define([
    ...
    'Cawl_CreditCard/js/model/tokenizer',
    'Cawl_CreditCard/js/view/credit-card/create-payment',
    'Cawl_CreditCard/js/view/credit-card/create-surcharge',
    'Cawl_PaymentCore/js/model/device-data',
    'Cawl_PaymentCore/js/model/message-manager',
    ...
    return Component.extend({
        defaults: {
            template: 'Cawl_CreditCard/payment/worldlinecc',
